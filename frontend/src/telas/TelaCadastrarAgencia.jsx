        ...
        <Form noValidate validated={validado} onSubmit={manipulaSubmissao}>
          ...
          <Row>
            <Form.Group className='mb-3' style={{ width: '340px' }} controlId='endereco'>
              ...
              <Form.Control required type='text' id='telefone' value={agencia.telefone} onChange={manipularMudanca} />
              <Form.Control.Feedback type='invalid'>Informe o telefone da agência!</Form.Control.Feedback>
            </Form.Group>
          </Row>
          {/*********************** PRODUTOS ***********************/}
          <Row>
